...
let UserRoleGuard = class UserRoleGuard {
    ...
    canActivate(context) {
        const validRoles = this.reflector.get(auth_decorator_1.META_ROLES, context.getHandler());
        ...
        throw new common_1.ForbiddenException(`User: ${user['name']} need valid role.`);
    }
};
